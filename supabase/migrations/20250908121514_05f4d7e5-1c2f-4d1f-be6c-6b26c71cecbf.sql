...
-- Update equipment_tracking to include ambulance_id references
UPDATE public.equipment_tracking 
SET ambulance_id = 'AMB-001' 
WHERE ambulance_id = 'default' OR ambulance_id IS NULL OR ambulance_id = '';

-- Insert sample equipment data for ambulances
...
VALUES
  ('AMB-001', 'medical', 'Defibrilator', 'unit', 'operational', 1, 1, 'System', 'Berfungsi normal'),
  ('AMB-001', 'oxygen', 'Oksigen', 'bar', 'operational', 85, 100, 'System', 'Level normal'),
  ('AMB-001', 'transport', 'Tandu', 'unit', 'operational', 1, 1, 'System', 'Kondisi baik'),
  ('AMB-001', 'medical', 'Obat-obatan', 'set', 'operational', 1, 1, 'System', 'Lengkap'),
  ('AMB-002', 'medical', 'Defibrilator', 'unit', 'operational', 1, 1, 'System', 'Berfungsi normal'),
  ('AMB-002', 'oxygen', 'Oksigen', 'bar', 'operational', 90, 100, 'System', 'Level normal'),
  ('AMB-002', 'transport', 'Tandu', 'unit', 'operational', 1, 1, 'System', 'Kondisi baik'),
  ('AMB-002', 'medical', 'Obat-obatan', 'set', 'operational', 1, 1, 'System', 'Lengkap');