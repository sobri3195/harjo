...
interface UserGPSPermissionDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onPermissionGranted: () => void;
}

export const UserGPSPermissionDialog: React.FC<UserGPSPermissionDialogProps> = ({
  open,
  onOpenChange,
  onPermissionGranted
}) => {
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Izin Akses Lokasi - User
          </DialogTitle>
          <DialogDescription>
            Aplikasi user memerlukan akses GPS untuk pelaporan darurat dan tracking lokasi
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          {permissionState === 'prompt' && (
            <div className="text-center space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-2">Aktifkan GPS untuk Pelaporan Darurat</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  Aplikasi user memerlukan akses lokasi untuk:
                </p>
                <ul className="text-sm text-muted-foreground text-left space-y-1">
                  <li>• Melaporkan lokasi darurat yang akurat</li>
                  <li>• Berbagi lokasi dengan tim medis</li>
                  <li>• Membantu ambulans menemukan lokasi Anda</li>
                  <li>• Tracking real-time untuk keamanan</li>
                </ul>
              </div>
              <Button 
          ...
          {permissionState === 'granted' && (
            <div className="text-center space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-foreground">GPS Aktif!</h3>
                <p className="text-sm text-muted-foreground">
                  Aplikasi user siap untuk pelaporan darurat
                </p>
              </div>
            </div>
          )}
          ...
          {permissionState === 'denied' && (
            <div className="space-y-4">
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  Akses GPS ditolak. Fitur pelaporan darurat tidak dapat berfungsi tanpa lokasi.
                </AlertDescription>
              </Alert>
